...
function create_lower_button_div(){
    ...
    var create_object_btn = $('<i>', {
                            class: 'pallet pallet-create-obj-btn pallet-btn glyphicon glyphicon-plus',
    ...
    var sel_background_btn = $('<i>', {
                             class: 'pallet pallet-sel-bg-btn pallet-btn fa fa-paint-roller',
    ...
    var bg_fill_btn = $('<i>', {
                      class: 'pallet pallet-create-fill-btn pallet-btn fa fa-fill',
    ...
    var gradient_sel_btn = $('<i>', {
                           class: 'pallet pallet-gradient-sel-btn pallet-btn fa fa-palette'});
    gradient_sel_div.append(gradient_sel_btn);
    row_a.append(gradient_sel_div);
...
function open_project_pallet(pid, project_title){
    ...
    pallet_title_div.append(pallet_title);
